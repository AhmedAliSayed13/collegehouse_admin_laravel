										...
										<td>
											<h2 class="table-avatar">
												<a class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle"
														...
														alt="User Image"></a>
												<a> Ruby Perrin <span class="text-primary d-block">Team
														Leader</span></a>
											</h2>
										</td>
										...
										<td>
											<h2 class="table-avatar">
												<a class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle"
														src="{{asset('images/profile/defult.png')}}"
														alt="User Image"></a>
												<a> 5480 <span class="text-primary d-block">Total tenants</span></a>
											</h2>
										</td>
							...
							<table class="datatable table table-hover table-center mb-0">
								...
								<tbody>
									<tr>
										...
										<td class="text-right">521$ <span class="text-primary d-block"> From 34
												tenant</span></td>
