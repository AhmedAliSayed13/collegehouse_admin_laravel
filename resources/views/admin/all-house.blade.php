									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-sm-5 col mb-3">
												<a href="{{route('add-house')}}"
													class="btn btn-primary float-right mt-2">Add a New House</a>
											</div>
													...
													<thead>
														<tr role="row">
															...
															<th class="sorting" tabindex="0"
																...
																style="width: 179.6px;">address</th>
																
															<th class="sorting" tabindex="0"
																
																
																style="width: 239.6px;"> Type</th>
															<th class="sorting" tabindex="0"
																
																
																style="width: 138px;">Status</th>
															<th class="sorting" tabindex="0"
