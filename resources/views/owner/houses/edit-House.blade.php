                                    ...
                                    <select id="owner_id" type="text"
                                        ...
                                        @foreach ($owners as $owner)
                                            <option value="{{ $owner['id'] }}"
                                                {{ option_select(old('owner_id', $house->owner_id), $owner['id']) }}>
                                                {{ $owner->fullname() }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="city_id" type="text"
                                        ...
                                        @foreach ($citys as $city)
                                            <option {{ option_select(old('city_id', $house->city_id), $city->id) }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="house_type_id"
                                        ...
                                        name="house_type_id" autocomplete="house_type_id" autofocus>
                                        <option value="option1">House Type</option>
                                        @foreach ($house_types as $house_type)
                                            <option
                                                {{ option_select(old('house_type_id', $house->house_type_id), $house_type->id) }}
                                                value="{{ $house_type->id }}">{{ $house_type->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('house_type_id')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="num_residents" placeholder="Number Residents" type="number"
                                        ...
                                        autocomplete="num_residents" autofocus>
                                    @error('num_residents')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="num_bathrooms" placeholder="Number Bathrooms" type="number"
                                        ...
                                        autocomplete="num_bathrooms" autofocus>
                                    @error('num_bathrooms')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="num_flooers" placeholder="number Flooers" type="number"
                                        ...
                                        value="{{ old('num_flooers', $house->num_flooers) }}" autocomplete="num_flooers"
                                        autofocus>
                                    @error('num_flooers')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
             ...
             {{ old('about', $house->about) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="upload-wrap d-flex">
                                        <div class="upload-images">
                                            <img src="http://127.0.0.1:8000/images/houses/{{ $house->image_ownership }}"
                                                alt="Upload Image">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="upload-images">
                                        <img src="http://127.0.0.1:8000/images/houses/{{ $house->image_lease }}"
                                            alt="Upload Image">
                    ...
                    <div class="upload-wrap d-flex">
                        @foreach ($front_images as $front_image)
                            <div class="upload-images">
                                ...
                                <form method="post" action="{{ url('owner/house/delete-image-front') }}">
                                    {{ csrf_field() }}
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row form-row education-cont">
                                <div class="col-12 col-md-10 col-lg-11">
                                    @foreach ($flooers as $flooer)
                                        <form method="post" action="{{ route('owner.edit-flooer') }}"
                                            ...
                                            <div class="row form-row">
                                                ...
                                                <div class="col-12 col-md-2 col-lg-1">
                                                    ...
                                                    <a href="{{ route('owner.delete-flooer', [$flooer->id]) }}"
                            ...
                            <form method="Post" action="{{ route('owner.create-flooer') }}" enctype="multipart/form-data">
                                @csrf
