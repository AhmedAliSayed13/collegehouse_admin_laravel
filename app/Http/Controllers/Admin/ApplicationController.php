...
//             'image_ownership' => ['required', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
//             'image_lease' => ['required',  'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
//             'front_house_images' => ['required'],
//             'front_house_images.*' => [ 'mimes:jpeg,png,jpg,gif,svg'],
...
//         $success = "Add New Application Successfully";
//         return back()->with('success', $success);
    ...
    public function edit($id)
    {
        ...
        // $house_types = House_type::all();
        // $payment_methods = Payment_method::all();
        // $house = Application::find($id);
        // $flooers=$house->flooers;
        // $front_images=$house->front_house_images;
        // return view('admin.houses.edit-Application', compact('owners', 'citys', 'house_types', 'payment_methods', 'house','front_images','flooers'));
    }
    public function update(Request $request, $id)
    {
        ...
        //     'annual_reset' => ['required', 'string'],
        //     'payment_method_id' => ['required', 'integer'],
        //     'image_ownership' => ['nullable',  'mimes:jpeg,png,jpg,gif,svg'],
        //     'image_lease' => ['nullable', 'mimes:jpeg,png,jpg,gif,svg'],
        ...
        // return Redirect::back()->with('success', 'Updated Application Successfully');
    ...
    public function destroy($id)
    {
        $house = Application::Find($id);
        $house->delete();
        return Redirect::back()->with('success', 'Deleted Application Successfully');
    }
