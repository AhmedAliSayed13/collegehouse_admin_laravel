...
//        }
        ...
        $success = "Add New Interview Successfully";
    ...
    public function edit($id)
    {
        ...
        return view('admin.houses.edit-Interview', compact('owners', 'citys', 'house_types', 'payment_methods', 'house','front_images','flooers'));
    }
    public function update(Request $request, $id)
    {
        ...
        return Redirect::back()->with('success', 'Updated Interview Successfully');
