...
class HouseController extends Controller
{
    ...
    {
        $id = auth()->user()->id;
        $houses = House::where('owner_id',$id)->get();
        return view('owner.houses.houses',compact('houses'));
    }
...
//        }
    ...
    public function edit($id)
    {
        ...
        return view('owner.houses.edit-House', compact('owners', 'citys', 'house_types', 'payment_methods', 'house','front_images','flooers'));
    }
